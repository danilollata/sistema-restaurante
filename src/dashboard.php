...
<div class="card">
    ...
    <!-- small box -->
    <a href="platos.php" class="small-box bg-info">
        <div class="inner">
...
<div class="col-lg-3 col-6">
    <!-- small box -->
    <a href="salas.php" class="small-box bg-success">
        <div class="inner">
...
<div class="col-lg-3 col-6">
    <!-- small box -->
    <a href="usuarios.php" class="small-box bg-warning">
        <div class="inner">
...
<div class="col-lg-3 col-6">
    <!-- small box -->
    <a href="lista_ventas.php" class="small-box bg-danger">
        <div class="inner">
