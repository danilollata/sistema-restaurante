    ...
    if (!empty($_POST)) {
        ...
        if (empty($plato) || empty($precio) || $precio < 0) {
            ...
            if (!empty($url_imagen)) {
                ...
                if (!@file_put_contents($nombre, file_get_contents($url_imagen))) {
                        ...
                        <div class="card-body">
                            <form action="" method="post" autocomplete="off" id="formulario" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label for="precio" class=" text-dark font-weight-bold">URL de la Imagen</label>
                                            <input type="text" placeholder="Pegue la url" class="form-control" name="url_imagen" id="url_imagen">
                                        </div>
                                    </div>
